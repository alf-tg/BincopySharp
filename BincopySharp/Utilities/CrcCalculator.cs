...
namespace BincopySharp.Utilities
{
    ...
    {
        /// <summary>
        /// Calculates the CRC for a Motorola S-Record from raw values, avoiding hex string parsing.
        /// </summary>
        ...
        public static byte CalculateSrecCrcRaw(byte byteCount, ulong address, int addressBytes, byte[]? data)
        {
            int sum = byteCount;
